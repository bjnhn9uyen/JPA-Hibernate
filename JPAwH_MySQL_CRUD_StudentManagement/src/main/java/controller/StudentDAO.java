...
public class StudentDAO {
	...
	/*
	 * create SessionFactory only 1 time. If you create new SessionFactory in every method below, Hibernate will reset database corresponding to each
	 * new SessionFactory in each method.
	 */
