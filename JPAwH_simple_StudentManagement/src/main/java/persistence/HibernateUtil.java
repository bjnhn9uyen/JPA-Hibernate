...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory() {
		...
		/* makes sure SessionFactory only created once at startup */
		if (sessionFactory == null) {
			sessionFactory = new MetadataSources(new StandardServiceRegistryBuilder().configure("hibernate.cfg.xml").build()).buildMetadata()
					.buildSessionFactory();
		}
